...
const DroneCV = require('./lib/dronecv.js');
const arDrone = require('ar-drone');
const UDPnavstream = require('../ar-drone/lib/navdata/UdpNavdataStream.js'); //hardcoded!
...
const pngEncoder = new Client.PngEncoder();
const videoStream = new Client.TcpVideoStream();
...
var dronecv = new DroneCV(pngEncoder,{ outputImage:true  },function(info){
...
dronecv.start(); // of dronecv.start()
